...
class PinholeDistortK2P2 final : public Camera
{
public:
	enum {
		OFFSET_FOCAL_X,
	...
	PinholeDistortK2P2(Eigen::Matrix<double, 8, 1>& intrinsic)
	{
		//Copy intrinsic
	...
	{
		return new ceres::AutoDiffCostFunction<PinholeDistortK2P2::Cost, 2, 8, 6, 3>(
			new PinholeDistortK2P2::Cost(observation)
			);
	}
